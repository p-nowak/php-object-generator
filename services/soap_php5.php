...
class ServiceClass
{
	...
	function GenerateConfiguration($wrapper = null, $pdoDriver = null, $db_encoding = 0)
	{
		...
		$data = str_replace('&soap', 'https://wingsdev.local/wings/pog/services/pog.wsdl', $data);
	...
	function GeneratePackage($objectName, $attributeList, $typeList, $language, $wrapper, $pdoDriver = null, $db_encoding = 0, $classList)
	{
		...
		$package["objects"][$objectName.".class.inc"] =  $this->GenerateObject($objectName, $attributeList, $typeList, $language, $wrapper, $pdoDriver, $classList);
